...
const Platforms = () => {
    return (
        <div className="container-fluid text-light bg-dark padding-custom">
            <h2 className="font-gigames pt-5 pb-2">Plataformas</h2>
            <div className="row d-flex justify-content-center align-items-center pt-4 pb-5">
